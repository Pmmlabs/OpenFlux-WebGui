...
func (g getProp) exec(vm *vm) {
	...
	if obj == nil {
		vm.throw(vm.r.NewTypeError("Cannot read properties of undefined (reading '%s')", g))
		return
	}
...
func (g getPropCallee) exec(vm *vm) {
	...
	n := unistring.String(g)
	if obj == nil {
		vm.throw(vm.r.NewTypeError("Cannot read properties of null (reading '%s')", n))
		return
	}
...
func (_getElem) exec(vm *vm) {
	...
	obj := v.baseObject(vm.r)
	if obj == nil {
		vm.throw(vm.r.NewTypeError("Cannot read properties of undefined (reading '%s')", vm.stack[vm.sp-1]))
		return
	}
	propName := toPropertyKey(vm.stack[vm.sp-1])
...
func (_getElemRecv) exec(vm *vm) {
	...
	obj := v.baseObject(vm.r)
	if obj == nil {
		vm.throw(vm.r.NewTypeError("Cannot read properties of undefined (reading '%s')", vm.stack[vm.sp-2]))
		return
	}
	propName := toPropertyKey(vm.stack[vm.sp-2])
...
func (_getKey) exec(vm *vm) {
	...
	propName := vm.stack[vm.sp-1]
	if obj == nil {
		vm.throw(vm.r.NewTypeError("Cannot read properties of undefined (reading '%s')", propName.String()))
		return
	}
