// Package bench implements the CLI's --role=bench-send/bench-sink
// benchmark modes: push or receive a fixed amount of data through a
// transport and report throughput/batching stats.
package bench
...
// RunSink receives packets and measures delivered goodput plus the
...
// RunSend pushes mb megabytes through the transport as ~MTU-sized packets,
